# API endpoint: https://ji9l7maz08.execute-api.us-east-1.amazonaws.com/default/get_sig_profit_loss
...
# Function to get the significant profit/loss
def get_sig_profit_loss(analysis_result):
    ...
    profit_loss = analysis_result['results']['profit_loss']
    return {
        'statusCode': 200,
...
def lambda_handler(event, context):
    ...
    # Determine which operation to perform based on event input
    operation = event.get('operation', 'avg_vars')

    return get_sig_profit_loss(latest_analysis)
