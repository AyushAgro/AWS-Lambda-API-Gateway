# API endpoint: https://ji9l7maz08.execute-api.us-east-1.amazonaws.com/default/get_chart_url
...
def get_chart_url(analysis_result):
    ...
    chart_url = analysis_result['results']['chart_url']
    return {
        'statusCode': 200,
        'body': json.dumps({'chart_url': chart_url})
    }
...
def lambda_handler(event, context):
    ...
    return get_chart_url(latest_analysis)
